        ...
        <div class="serch-cover">
            <div class="serch-con"  v-if="clesstops">
                ...
                <div class="cless" v-if="clessBoxShow">
                    ...
                    <div v-if="clessShow">
                        <router-link :to="{path:'/classesDetails',query: {id: item.id}}" class="serchtext"
                            ...
                            <router-link :to="{path:'/serchDetailsUniversity',query: {id: item.universityId}}"
                                         class="serchtext-nadu" :class="{serchtextnaduswitch:isserchTextSwitch}"><span
                                    v-if="isserchTextSwitch == false">School: </span><b>{{item.university}}</b>
                            </router-link>
                ...
                <div class="cless" v-if="contentBoxShow">
                    ...
                    <div v-if="contentShow">
                        <router-link
                                ...
                                class="serchtext" :class="{serchtextswitch:isserchTextSwitch}" v-for="item in value2">
                            <ul class="serchtext-top">
                                <p>{{item.id}}</p>
                            ...
                            <div class="serchtext-bootom">
                                ...
                                <!--</div>-->
                                <div class="text-boo-right">
                                    <p class="text-boo-right-p" :class="{textboorightPswitch:isserchTextSwitch}">
                                        {{item.contents}}</p>
                                </div>
                                <div class="serchtext-time">{{item.createTime | formatDate}}</div>
                            </div>
                ...
                <div class="cless" v-if="universityBoxShow">
                    ...
                    <div v-if="universityShow">
                        <router-link :to="{path:'/serchDetailsUniversity',query:{id:item.university.id}}"
                                     class="serchtext" :class="{serchtextswitch:isserchTextSwitch}"
