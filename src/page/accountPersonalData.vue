...
export default {
  ...
  data() {
    return {
      ...
      imageUrl: "",
      imageShow: false,
      imgSite: "http://47.254.29.164:8088/api/Client/UploadImg",
      myHeaders: {
      ...
      _this
        ...
        .then(function(res) {
          ...
          if (res.data.data.image) {
            _this.imageUrl = "http://47.254.29.164:8088" + res.data.data.image;
            _this.headShow = true;
          } else {
  ...
  methods: {
    ...
    handleAvatarSuccess(res, file) {
      ...
      var _this = this;
      _this.imageUrl = "http://47.254.29.164:8088" + res.data;
