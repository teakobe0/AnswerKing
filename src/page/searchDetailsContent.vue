...
#serchDetailsContent-tag-con-ul {
  border: 1px solid #e1e1e1;
}

#serchDetailsContent-tag-con-ul + span span i {
  color: #000;
}

.serchDetailsContent-tag-con-ul li {
  width: 138px;
  height: 50px;
  list-style-type: none;
...
.serchDetailsContent-tag-con-ul li a {
  display: block;
  line-height: 50px;
  width: 138px;
  height: 50px;
...
.serchDetailsContent-tag-con-ul li a:hover {
...
.el-carousel__item button:hover {
  color: #ffffff;
  ...
  methods: {
    ...
    ClassWeeks: function() {
      ...
      _this
        .axios({
          method: "get",
          url: `http://47.254.29.164:8088/api/ClassWeek/ClassWeeks`,
          async: false,
          params: {
        ...
        .then(function(res) {
          ...
          if (
            ...
            //   .axios({
            //     method: "get",
            //     url: `http://47.254.29.164:8088/api/ClassInfoContent/ClassWeekTypes`,
            //     async: false,
            //     params: {
            ...
            //   .axios({
            //     method: "get",
            //     url: `http://47.254.29.164:8088/api/ClassInfoContent/Contentls`,
            //     async: false,
            //     params: {
    ...
    getUrlList: function(rawList) {
      ...
      for (var i = 0; i < imgUrlArray.length; i++) {
        if (imgUrlArray[i].length != 0) {
          outputList.push({
            id: rawList.id,
            contentUrl: "http://47.254.29.164:8088" + imgUrlArray[i],
    ...
    getUrlListCover: function(rawList) {
      ...
      for (var i = 0; i < imgUrlArray.length; i++) {
        if (imgUrlArray[i].length != 0) {
          outputList.push("http://47.254.29.164:8088" + imgUrlArray[i]);
        }
      }
      return outputList;
    },
    ...
    Classinfos: function() {
      ...
      _this
        .axios({
          method: "get",
          url: `http://47.254.29.164:8088/api/Classinfo/Classinfos`,
          async: false,
          params: {
    ...
    ChangeClassInfo: function() {
      ...
      _this
        .axios({
          method: "put",
          url: `http://47.254.29.164:8088/api/Classinfo/ChangeClassInfo`,
          async: false,
          params: {
    ...
    UseRecord: function() {
      ...
      if (localStorage.token) {
        _this
          .axios({
            method: "get",
            url: `http://47.254.29.164:8088/api/Classinfo/UseRecords`,
            async: false,
            params: {
              classInfoid: Number(_this.$route.query.classInfoId)
            },
