                    ...
                    <div class="query-con-search">
                        <el-autocomplete
                            ...
                            <template slot-scope="{ item }">
                                <span>{{item.value}}</span>-<span style='color:#878787;'>{{item.type}}</span>
                            </template>
                        </el-autocomplete>
                    </div>
                    ...
                    <div class="find-select-bootom">
                        <ul>
                            <li v-for="item in universitys">
                                <router-link :to="{path:'/serchDetailsUniversity',query: {id: item.university.id}}">{{item.university.name}}</router-link>
                                <div class="select-boo-num">{{item.number}}门课程 </div>
                            </li>
                        </ul>
                    </div>
                    <div @click="viewMore" class="viewmores">查看更多</div>
...
<script type="es6">
    ...
    export default {
        ...
        methods: {
            viewMore:function(){
                var _this = this;
                _this.universitys = _this.alluniversitys.slice(0,_this.universitys.length + _this.pageSize)
            },
