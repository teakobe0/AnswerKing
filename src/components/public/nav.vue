    ...
    <div :class="searchBarFixed == true ? 'Navcolor' : ''">
      <div class="Nav-con">
        ...
        <ul>
          ...
          <li v-if="$store.state.logo.show">
            <router-link class="Nav-resi" to="/register">{{
              $t("nav.nav6")
            }}</router-link>
          </li>
          <li v-if="$store.state.logo.hide">
            <router-link to="/personalData" id="nicknames"
              ><img src="../../assets/个人中心.svg" alt="" />
              <div
                :class="{ messageRed: this.$store.state.logo.message >= 1 }"
              ></div>
            </router-link>
                  ...
                  <ul>
                    ...
                    <li>
                      <router-link to="/personalData/inform"
                        >{{ $t("nav.nav8")
                        }}<span v-show="this.$store.state.logo.message >= 1"
                          >({{ this.$store.state.logo.message }})</span
                        >
                        <div
                          :class="{
                            messageReds: this.$store.state.logo.message >= 1,
                          }"
                        ></div>
                      </router-link>
                    </li>
