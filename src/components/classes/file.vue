    ...
    <div id="file">
        <div class="file-con">
            ...
            <div class="file-con-course">
                <router-link :to="{path:'/serchDetailsContent',query:{id:item.classId,classInfoId:item.id}}" class="file-course-img" v-for="item in value" >
...
<script type="es6">
    ...
    export default {
        ...
        methods: {
            ...
            //        }
            //    }).then(function (res) {
            //        _this.classesvalue = res.data.data
